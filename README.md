...
The campus verifier checks the generated `.blend` for required facilities and verifies that at least 23 numbered campus preview images plus the overview contact sheet exist.
